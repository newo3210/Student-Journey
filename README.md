...
- `ARCHITECTURE_SDD.md` — technical architecture (EN)
- `STUDENT_DECISION_LOG.md` — decision log / oral defense (ES)
- `docs/LEARNING_ROADMAP.md` — study + build tracks
