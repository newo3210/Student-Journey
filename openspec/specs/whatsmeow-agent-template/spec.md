# whatsmeow-agent-template

## Purpose

Runnable WhatsMeow Level 1 WhatsApp agent in Go: HTTP simulator, default binary linking go.mau.fi/whatsmeow for QR and send, numbered text menu, presence plus delay humanization.
## Requirements
