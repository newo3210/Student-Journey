...
// Inbound handler deps - Waha client, coupon URL, humanize range, optional sleep.
...
// Handle inbound webhook - parses Waha POST body and humanized-sends demo replies.
