...
// Build text message - Waha sendText shape from validated input.
...
// Build interactive buttons message - Waha sendButtons shape.
...
// Build interactive list message - Waha sendList shape.
...
// Build media message - Waha sendFile/sendImage image or document.
